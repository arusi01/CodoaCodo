...
public class Vista extends javax.swing.JFrame {
    ...
    public void mostrar() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            matriz[i][3]=Integer.toString(lista.get(i).getCant());
            matriz[i][4]=Double.toString(lista.get(i).getPrecio()*lista.get(i).getCant());            
        }
        
        String titulo[]={"Id","Producto","Precio","Cantidad","Total"};
//        DefaultTableModel modelo = new DefaultTableModel(matriz, titulo);
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.Boolean.class, java.lang.Integer.class, java.lang.Boolean.class
            };
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Producto producto = new Producto(id,prod,precio,cant);
        lista.add(producto);
